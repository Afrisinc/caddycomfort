      ...
      <div className="min-h-screen bg-background pt-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 mb-16">
            <ProductGallery images={images} name={product.name} hasDiscount={hasDiscount} discountPct={discountPct} />
            <ProductInfoPanel product={product} averageRating={averageRating} reviewCount={reviewCount} />
          </div>
