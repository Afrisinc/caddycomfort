    ...
    <div className="min-h-screen bg-background p-8">
      <div className="max-w-7xl mx-auto space-y-16">
        ...
        <section className="text-center space-y-6 py-20">
          <h1 className="text-gradient-rose">CaddyComfort</h1>
        ...
        <section className="space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <Card className="p-6 space-y-4 shadow-luxury">
              ...
              <p className="text-muted-foreground">Premium collection piece with luxury finish</p>
              <div className="flex justify-between items-center">
            ...
            <Card className="p-6 space-y-4 border-accent-rose">
              ...
              <p className="text-muted-foreground">Fresh from the runway, limited edition</p>
              <div className="flex justify-between items-center">
