...
function EditCategoryForm({ id }: { id: string }) {
  ...
  return (
    <div className="min-h-screen bg-muted/30">
      <AdminHeader title="Edit Category" description="Update this category's details">
                  ...
                  <div className="space-y-3">
                    {imagePreview ? (
                      ...
                      <div className="border-2 border-dashed rounded-lg p-8 text-center">
                        ...
                        <p className="text-sm text-muted-foreground mb-4">Upload category image</p>
      ...
      <ConfirmDeleteDialog
        ...
        warning={
          blockedDeleteReason && `${blockedDeleteReason} — remove those first before deleting.`
        }
