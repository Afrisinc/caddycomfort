        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 prose prose-lg max-w-none">
          <div className="space-y-8 text-muted-foreground">
            <section>
              ...
              <p>
                Welcome to CaddyComfort. We respect your privacy and are committed to protecting
            ...
            <section>
              ...
              <ul className="space-y-2 ml-6">
                <li>
                  <strong className="text-foreground">Identity Data:</strong> first name, last name,
                  username
                </li>
                <li>
                  <strong className="text-foreground">Contact Data:</strong> email address,
                  telephone numbers, billing and delivery addresses
                </li>
                <li>
                  <strong className="text-foreground">Financial Data:</strong> payment card details
                </li>
                <li>
                  <strong className="text-foreground">Transaction Data:</strong> details about
                  payments and orders
                </li>
                <li>
                ...
                <li>
                  <strong className="text-foreground">Usage Data:</strong> how you use our website
                  and products
                </li>
                <li>
                  <strong className="text-foreground">Marketing Data:</strong> your preferences in
            ...
            <section>
              ...
              <p>
                ...
                your personal data to employees and partners who have a business need to know. All
            ...
            <section>
              ...
              <ul className="space-y-2 ml-6">
                <li>
                  <strong className="text-foreground">Service Providers:</strong> Payment
                  processors, delivery services, marketing platforms
                </li>
                <li>
                  <strong className="text-foreground">Business Partners:</strong> For joint
              ...
              <p className="mt-3">
                We require all third parties to respect the security of your personal data and treat
            ...
            <section>
              ...
              <ul className="space-y-2 ml-6">
                <li>
                  <strong className="text-foreground">Right to Access:</strong> Request copies of
                  your personal data
                </li>
                <li>
            ...
            <section>
              ...
              <p>
                ...
                you with a good experience and allows us to improve our site. Cookies are small
                files stored on your device that help us analyze web traffic and remember your
                preferences.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                ...
                purposes for which we collected it, including legal, accounting, or reporting
                requirements. When we no longer need your data, we will securely delete or anonymize
                it.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                ...
                collect data from children. If you believe we have collected data from a child,
