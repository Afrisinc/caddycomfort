...
class DashboardService {
    ...
    static async getOverallStats() {
        const [totalUsers, totalProducts, totalOrders, totalRevenue, pendingOrders, completedOrders, activeProducts, lowStockProducts,] = await Promise.all([
    ...
    static async getCustomerInsights() {
        ...
        const topCustomersWithSpending = await Promise.all(topCustomers.map(async (customer) => {
